@Checkout
  ...
  Scenario: Add an item to cart
    ...
    Then user see the correct price for "Test.allTheThings() T-Shirt (Red)" as productName
    Then user see the correct tax for "Test.allTheThings() T-Shirt (Red)" as productName
